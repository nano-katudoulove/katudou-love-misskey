		...
		super(meta, paramDef, async (ps) => {
			...
			return {
				...
				catchphrase: site.catchphrase,
                                extendedProfile: site.extendedProfile,
				...
				guidelineText: site.guidelineText,
                                newsTitle1: site.newsTitle1,
                                newsText1: site.newsText1,
                                newsTitle2: site.newsTitle2,
                                newsText2: site.newsText2,
                                newsTitle3: site.newsTitle3,
                                newsText3: site.newsText3,
                                themeColor: site.themeColor,
                                linkLabel1: site.linkLabel1,
                                linkUrl1: site.linkUrl1,
                                linkLabel2: site.linkLabel2,
                                linkUrl2: site.linkUrl2,
                                linkLabel3: site.linkLabel3,
                                linkUrl3: site.linkUrl3,
